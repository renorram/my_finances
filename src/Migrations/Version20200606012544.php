 ...
 */
final class Version20200606012544 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE transactions (id INT NOT NULL, expense_id INT DEFAULT NULL, income_id INT DEFAULT NULL, description VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_EAA81A4CF395DB7B ON transactions (expense_id)');
        $this->addSql('CREATE INDEX IDX_EAA81A4C640ED2C0 ON transactions (income_id)');
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, roles JSON NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, preferred_currency VARCHAR(3) NOT NULL, balance_amount INT NOT NULL, balance_currency VARCHAR(3) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE transactions ADD CONSTRAINT FK_EAA81A4CF395DB7B FOREIGN KEY (expense_id) REFERENCES expense (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE transactions ADD CONSTRAINT FK_EAA81A4C640ED2C0 FOREIGN KEY (income_id) REFERENCES income (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transactions DROP CONSTRAINT FK_EAA81A4CF395DB7B');
        ...
        $this->addSql('ALTER TABLE transactions DROP CONSTRAINT FK_EAA81A4C640ED2C0');
